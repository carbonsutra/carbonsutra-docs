...
<meta
  name="keywords"
  content="Carbon Footprint API, Scope 1 2 3 emissions engine, CSRD compliance, GHG Protocol, Google Sheets CO2 functions, MCP Server carbon calculation, AI agent sustainability tools, audit-proof carbon accounting"
/>
<meta
  property="og:title"
  content="Carbon Accounting REST APIs, Sheets & MCP Server | CarbonSutra"
/>
<meta
  property="og:description"
  content="Simplify greenhouse gas calculations across Scope 1, 2, and 3 with transparent, audit-ready APIs, spreadsheet functions, and AI-native MCP servers."
/>
...
![CarbonSutra](/images/carbonsutra-landing-page.jpg)

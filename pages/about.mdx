...
<Head>
  <title>About Us | CarbonSutra</title>
  <meta
    name="description"
    content="Learn about CarbonSutra, our ClimateTech expertise, emissions management solutions, and the team behind our carbon calculation APIs."
  />
  <meta
    name="keywords"
    content="CarbonSutra, ClimateTech, carbon emissions, emissions management, carbon calculation API, decarbonization"
  />
</Head>

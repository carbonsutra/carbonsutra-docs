...
<meta
  name="keywords"
  content="flight time api, estimated flight duration, airport distance calculator, haversine formula travel time, flight time estimation api, carbonsutra api"
/>
<meta
  property="og:title"
  content="Estimated Flight Times between Airports | CarbonSutra"
/>
<meta
  property="og:description"
  content="Calculate precise flight travel times between airports using transparent algorithms, Haversine distance, and airport taxi penalties."
/>

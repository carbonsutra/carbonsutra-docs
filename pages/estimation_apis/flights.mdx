...
<meta
  name="keywords"
  content="Flight Carbon Footprint API, Scope 3 air travel emissions, IATA airport carbon calculator, CSRD flight compliance, OpenAPI carbon estimation, CarbonSutra flight API"
/>
<meta
  property="og:title"
  content="Business Flight Travel Carbon Emissions API | CarbonSutra"
/>
<meta
  property="og:description"
  content="Programmatically calculate audit-proof air travel carbon footprints with transparent, compliance-ready explanations and global IATA coverage."
/>

...
<meta
  name="keywords"
  content="Vehicle Carbon Footprint API, Scope 1 2 3 emissions engine, vehicle emissions by type, Scope 3 commute emissions, CSRD compliance, audit-proof carbon accounting, REST API, JSON schema, OpenAPI"
/>
<meta
  property="og:title"
  content="Vehicle Carbon Emissions API by Type & Fuel | CarbonSutra"
/>
<meta
  property="og:description"
  content="Calculate auditable CO2e footprint for vehicle travel across car types, fuel, and distances. Features audit-ready explanations and automated WTT support."
/>

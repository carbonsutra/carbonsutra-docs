...
<meta
  name="keywords"
  content="eCommerce shipping carbon footprint API, calculate postal code CO2 emissions, Scope 3 freight calculation API, land air shipment carbon calculator, ECTA DEFRA conversion factors, CarbonSutra API"
/>
<meta
  property="og:title"
  content="eCommerce Shipment Carbon Footprint API | CarbonSutra"
/>
<meta
  property="og:description"
  content="Compute land and air travel carbon emissions across 1.5M+ global postal codes and 9,000 airports using CarbonSutra's auditable REST API."
/>

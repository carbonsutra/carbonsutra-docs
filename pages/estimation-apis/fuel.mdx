...
<meta
  name="keywords"
  content="fuel carbon footprint api, scope 1 stationary combustion, ghg protocol fuel emissions, carbon emissions api, csrd fuel accounting, carbonsutra"
/>
<meta
  property="og:title"
  content="Fuel Combustion Carbon Footprint API | CarbonSutra"
/>
<meta
  property="og:description"
  content="Calculate Scope 1 fuel combustion emissions (gas, liquid, solid) with audit-ready conversion factors and automated explanations via REST API."
/>

...
<meta
  name="keywords"
  content="Freight Carbon Footprint API, Scope 3 freight shipping emissions, REST API freight CO2e, intermodal shipment calculation, CSRD freight compliance, CarbonSutra freight estimate"
/>
<meta
  property="og:title"
  content="Freight Shipping Carbon Footprint API | CarbonSutra"
/>
<meta
  property="og:description"
  content="Calculate accurate Scope 3 carbon emissions for road, rail, air, sea, and intermodal freight shipping with audit-proof REST API integration."
/>

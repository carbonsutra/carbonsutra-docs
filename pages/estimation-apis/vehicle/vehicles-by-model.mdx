...
<meta
  name="keywords"
  content="Vehicle Emission API, Scope 3 vehicle footprint, CO2e vehicle make model API, CSRD fleet emissions, vehicle carbon calculation REST API"
/>
<meta
  property="og:title"
  content="Vehicle Emission by Model API | CarbonSutra"
/>
<meta
  property="og:description"
  content="Calculate greenhouse gas emissions by vehicle make and model across 145+ makes and 5,000+ models with audit-ready accuracy."
/>
...
2. The use of two APIs to get Make and Model is optional, esp if you know the Model for which you are estimating the emissions. We have made the entire database available in this documentation, which is structured by an alphabetical list of Models for every Make used by the API.
